...
global.readmessagefrom = process.env.READ_MESSAGE_FROM || "2348100835767";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "©️ 𝛲𝛩𝑊𝛯𝑅𝐷 𝐵𝑌 𝔸𝕂𝕍𝕀𝔻-𝕄𝔻",
  author: process.env.PACK_AUTHER || "AKVID-ᴍᴅ",
  packname: process.env.PACK_NAME || "♥️",
  botname: process.env.BOT_NAME || "AKVID-MD",
  ownername: process.env.OWNER_NAME || "AKVID",
