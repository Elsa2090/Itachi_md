...
global.website = 'https://github.com/Elsa2090/Itachi_md' //wa.me/+91000000000000
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/337f2dba14674a1e7b085.mp4'
module.exports = {
  sessionName: process.env.SESSION_ID || "",      //Put Your Session Id Here
  author:  process.env.PACK_AUTHER ||  'ITACHI BOT',
  packname:  process.env.PACK_NAME || 'MADE BY BRYANT TECH',
  
  botname:   process.env.BOT_NAME === undefined ? "ITACHI-MD" : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'Brysnttech' : process.env.OWNER_NAME,  
