...
smd({ cmdname: "updatenow", type: "owner", info: "Downloads the entire Git repository from https://github.com/Kingdavid3333/AKVID-MD on the root of the app.", fromMe: s_ser, filename: __filename }, async (message) => {
  try {
    const repoUrl = 'https://github.com/Kingdavid3333/AKVID-MD.git';
  ...
  async (message, args) => {
    try {
      ...
      if (url.toLowerCase().includes("https")) {
        ...
        return await message.send("`AKVID MD UPDATE WAS SUCCESSFULL ✅`");
      } else {
      ...
      const designs = [
        async () => {
          const imageBuffer = await axios.get(
            "https://telegra.ph/file/78fe770577874437b97d8.jpg",
            {
          ...
          const captionText = `卂Ҝᐯ丨ᗪ 2.0.0 𝛲𝛥𝑇𝐶𝛨\n\n*Ping:* ${pingSeconds} seconds${quoteText}\n\n 卂Ҝᐯ丨ᗪ `;
    ...
    try {
      ...
      if (!_0x5eb566) {
        return await _0x15cc76.reply(
          "*Please Give Me Text. Example: _" + prefix + "trt en i love AKVID_*"
        );
      }
